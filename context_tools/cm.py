...
def summarize_chef_data(
    ...
    :param credentials: Dict with "chef_server_url", "client_key", "client_name".
    :param api_key: Gemini API key.
    :param model_name: Which Gemini model to use.
