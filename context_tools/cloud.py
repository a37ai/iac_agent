...
1. AWS:
   ...
   aws_credentials = {
       ...
       "secret_access_key": "xxxSECRETxxx",
       "session_token": "xxxOPTIONALxxx",  # if STS tokens are used
...
def fetch_gcp_data(credentials: Dict[str, Any]) -> Dict[str, Any]:
    ...
    service_account_file = service_account_file.get("content")
    ...
    try:
        ...
        gcp_creds = service_account.Credentials.from_service_account_info(json.loads(service_account_file))
...
if __name__ == "__main__":
    ...
    aws_credentials = {
        ...
        # "session_token": "..."  # optional if using STS sessions
        "region_name": "us-east-1",
        # "role_arn": "arn:aws:iam::1234567890:role/MyRole"  # optional
    }
