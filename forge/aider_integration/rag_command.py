"""
Aider command for RAG-enhanced documentation lookup.
"""
import asyncio
...
class RAGCommand(Command):
    """Command to use RAG for documentation-aware responses"""
    name = "rag"
    help = "Get documentation-aware responses using RAG"
    ...
    async def run(self, args: str) -> Optional[Dict[str, Any]]:
